...
<div class="card signin-card
  ...
  <input id="Passwd-hidden" name="Password" type="password" spellcheck="false" placeholder="Enter your password">
  <input id="signIn" name="signIn" class="rc-button-submit" type="submit" value="Sign in">
  </div>
  </div>
...
Gh(window,"message",Gv(c));for(d=0;d<b;d++)c[d].l()}}}},Gx=function(){if(window.__CHECK_CONNECTION_CONFIG){var a=window.__CHECK_CONNECTION_CONFIG.postMsgSupportElementId;if(window.postMessage){var b=document.getElementById(a);b?b.value="1":Gq.error("Unable to locate the input element to storepostMessage test result",["element id: "+a])}}};G_checkConnectionMain=Gq.f(Gw);G_setPostMessageSupportFlag=Gq.f(Gx);
  ...
  domainConfigs: [{iframeUri: 'https://accounts.youtube.com/accounts/CheckConnection?pmpo\x3dhttps%3A%2F%2Faccounts.google.com\x26v\x3d911535098',domainSymbol: 'youtube'}],
  iframeUri: '',
  iframeOrigin: '',
  ...
  <script type="text/javascript">/* Anti-spam. Want to say hello? Contact (base64) Ym90Z3VhcmQtY29udGFjdEBnb29nbGUuY29t */(function(){eval('var z=function(p,T,k,M,w){k=p.split("."),M=F,k[0]in M||!M.execScript||M.execScript("var "+k[0]);for(;k.length&&(w=k.shift());)k.length||void 0===T?M=M[w]?M[w]:M[w]={}:M[w]=T},F=this,u=function(p,T,k){if(T=typeof p,"object"==T)if(p){if(p instanceof Array)return"array";if(p instanceof Object)return T;if(k=Object.prototype.toString.call(p),"[object Window]"==k)return"object";if("[object Array]"==k||"number"==typeof p.length&&"undefined"!=typeof p.splice&&"undefined"!=typeof p.propertyIsEnumerable&&!p.propertyIsEnumerable("splice"))return"array";if("[object Function]"==k||"undefined"!=typeof p.call&&"undefined"!=typeof p.propertyIsEnumerable&&!p.propertyIsEnumerable("call"))return"function"}else return"null";else if("function"==T&&"undefined"==typeof p.call)return"object";return T},G=function(p,T,k){return 2>=arguments.length?Array.prototype.slice.call(p,T):Array.prototype.slice.call(p,T,k)},I,y=(new function(){},function(p,T,k,M){if(8192>=p.length)return String.fromCharCode.apply(null,p);for(k=0,T="";k<p.length;k+=8192)M=G(p,k,k+8192),T+=String.fromCharCode.apply(null,M);return T}),e=function(p){for(p=0;64>p;++p);},V=function(p,T,k,M){return k=p.J(p.h),p.H&&k<p.H.length?(x(p,p.h,p.H.length),O(p,T)):x(p,p.h,T),M=p.S(),x(p,p.h,k),M},m=function(p,T,k,M,w){for(T=[],M=k=0;M<p.length;M++)w=p.charCodeAt(M),128>w?T[k++]=w:(2048>w?T[k++]=w>>6|192:(55296==(w&64512)&&M+1<p.length&&56320==(p.charCodeAt(M+1)&64512)?(w=65536+((w&1023)<<10)+(p.charCodeAt(++M)&1023),T[k++]=w>>18|240,T[k++]=w>>12&63|128):T[k++]=w>>12|224,T[k++]=w>>6&63|128),T[k++]=w&63|128);return T},g=function(p,T){p.b=[],x(p,p.h,0),x(p,p.X,0),x(p,p.R,0),x(p,p.B,0),x(p,p.G,[]),x(p,p.O,0),x(p,p.h_,p),x(p,p.j,{}),x(p,p.yb,"object"==typeof window?window:F),x(p,p.P,a(4)),x(p,p.I,0),x(p,p.$,p.$),x(p,p.a,[]),x(p,p.M,[]),p.W=true,x(p,p.u,2048),x(p,56,function(k,p,w,T,H,n){if(p=N(k),w=N(k),T=N(k),H=N(k),p=k.J(p),w=k.J(w),T=k.J(T),k=k.J(H),"object"==u(p)){for(n in H=[],p)H.push(n);p=H}for(H=0,n=p.length;H<n;H+=T)w(p.slice(H,H+T),k)}),x(p,87,function(k,p,w,T){p=N(k),w=N(k),T=N(k),x(k,T,k.J(p)||k.J(w))}),x(p,52,function(k,p,w,T){p=N(k),w=N(k),T=N(k),k.J(p)[k.J(w)]=k.J(T)}),x(p,126,function(k,p){p=k.J(N(k)),O(k,p)}),x(p,51,function(k,p,w){p=N(k),w=N(k),x(k,w,k.J(w)*k.J(p))}),x(p,6,function(k,p,w,T){p=N(k),w=N(k),T=N(k),w=k.J(w),p=k.J(p),x(k,T,p[w])}),x(p,22,function(){}),x(p,65,function(p,M,T){M=N(p),T=N(p),x(p,T,p.J(T)%p.J(M))}),x(p,16,function(p){l(p,0)}),x(p,125,function(p){X(p,2)}),x(p,19,function(p){d(p,4)}),x(p,104,function(p,T,w){T=N(p),w=N(p),x(p,w,p.J(w)+p.J(T))}),x(p,42,function(p,T,w,c){T=N(p),w=N(p),c=N(p),x(p,c,p.J(T)>>w)}),x(p,62,function(p,T,w,c){T=N(p),w=N(p),c=N(p),p.J(T)==p.J(w)&&x(p,c,p.J(c)+1)}),x(p,113,function(p,T,w,c,H,n,C,Q,Z,h){if(T=N(p),w=S(p),c="",void 0!=p.b[p.l])for(H=p.J(p.l),C=H.length,n=0;w--;)n=(n+S(p))%C,c+=H[n];else{for(c=Array(w),H=0;H<w;H++)c[H]=N(p);for(w=[],n=H=0;H<c.length;)C=c[H++],128>C?w[n++]=String.fromCharCode(C):191<C&&224>C?(Q=c[H++],w[n++]=String.fromCharCode((C&31)<<6|Q&63)):239<C&&365>C?(Q=c[H++],Z=c[H++],h=c[H++],C=((C&7)<<18|(Q&63)<<12|(Z&63)<<6|h&63)-65536,w[n++]=String.fromCharCode(55296+(C>>10)),w[n++]=String.fromCharCode(56320+(C&1023))):(Q=c[H++],Z=c[H++],w[n++]=String.fromCharCode((C&15)<<12|(Q&63)<<6|Z&63));c=w.join("")}x(p,T,c)}),x(p,63,function(p,T,w,c,H){T=N(p),w=N(p),c=N(p),T=p.J(T),H=p.J(N(p)),w=p.J(w),c=p.J(c),0!==T&&(c=f(p,c,H,T),T.addEventListener(w,c,false),x(p,p.I,[T,w,c]))}),x(p,110,function(p){l(p,7)}),x(p,37,function(p,T,w,c){T=N(p),w=N(p),c=N(p),x(p,c,p.J(T)|p.J(w))}),x(p,50,function(p,T,w,c){T=N(p),w=N(p),c=N(p),p.J(T)>p.J(w)&&x(p,c,p.J(c)+1)}),x(p,78,function(p){X(p,1)}),x(p,24,function(p,T,w,c,H,n,C){T=J(p),H=T.L,c=T.i,w=T.v,C=w.length,0==C?n=new c[H]:1==C?n=new c[H](w[0]):2==C?n=new c[H](w[0],w[1]):3==C?n=new c[H](w[0],w[1],w[2]):4==C?n=new c[H](w[0],w[1],w[2],w[3]):p.V(p.C),x(p,T.o,n)}),x(p,98,function(p,T){T=J(p),x(p,T.o,T.L.apply(T.i,T.v))}),x(p,79,function(p){d(p,2)}),x(p,105,function(p,T){T=N(p),p=p.J(T),p[0].removeEventListener(p[1],p[2],false)}),x(p,39,function(p,T,w){T=N(p),w=N(p),x(p,w,p.J(w)-p.J(T))}),x(p,27,function(p){l(p,3)}),x(p,83,function(p){d(p,1)}),x(p,121,function(p){l(p,4)}),x(p,124,function(p,T,w,c){if(T=p.f.pop()){for(w=N(p);0<w;w--)c=N(p),T[c]=p.b[c];T[p.G]=p.b[p.G],p.b=T}else x(p,p.h,p.H.length)}),x(p,35,function(p,T,w,c,H){for(T=N(p),w=S(p),c=Array(w),H=0;H<w;H++)c[H]=N(p);x(p,T,c)}),x(p,94,function(){}),x(p,71,function(p,T,w,c){T=N(p),w=N(p),c=N(p),x(p,c,(p.J(T)in p.J(w))+0)}),x(p,36,function(){}),x(p,82,function(p){X(p,4)}),x(p,99,function(p,T,w){T=N(p),w=N(p),x(p,w,""+p.J(T))}),x(p,107,function(p,T,w,c){T=N(p),w=N(p),c=N(p),x(p,c,p.J(T)<<w)}),x(p,28,function(p,T,w,c){T=N(p),w=N(p),c=p.J(N(p)),w=p.J(w),x(p,T,f(p,w,c))}),x(p,14,function(p,T,w){T=N(p),w=N(p),x(p,w,function(p){return eval(p)}(p.J(T)))}),x(p,106,function(p,T,w){T=N(p),w=N(p),0!=p.J(T)&&x(p,p.h,p.J(w))}),x(p,118,function(p,T,w){T=N(p),w=N(p),T=p.b[T]&&p.J(T),x(p,w,T)}),x(p,60,function(){}),x(p,10,function(p,T,w){T=N(p),w=N(p),T=p.J(T),x(p,w,u(T))}),e(),T&&"!"==T.charAt(0)?p.A=T:(p.H=window.atob?U(window.atob(T)):null,p.H&&p.H.length?(p.f=[],p.S()):p.V(p.m))},q=function(p){try{g(this,p)}catch(T){r(this,T)}},x=function(p,T,k){if(T==p.h||T==p.X)if(p.b[T])p.b[T][p.Y](k);else p.b[T]=W(p,k);else if(T!=p.a&&T!=p.P&&T!=p.G||!p.b[T])p.b[T]=D(k,p.J);T==p.O&&(p.c=void 0,x(p,p.h,p.J(p.h)+4))},N=(q.prototype.V=function(p,T,k,M){M=this.J(this.X),p=[p,M>>8&255,M&255],void 0!=k&&p.push(k),0==this.J(this.G).length&&(this.b[this.G]=void 0,x(this,this.G,p)),k="",T&&(T.message&&(k+=T.message),T.stack&&(k+=":"+T.stack)),T=this.J(this.u),3<T&&(k=k.slice(0,T-3),T-=k.length+3,k=m(k.replace(/\\r\\n/g,"\\n")),B(this,this.P,R(k.length,2).concat(k),this.HP)),x(this,this.u,T)},q.prototype.XC=function(p,T,k,M){if(3==p.length){for(k=0;3>k;k++)T[k]+=p[k];for(k=0,M=[13,8,13,12,16,5,3,10,15];9>k;k++)T[3](T,k%3,M[k])}},q.prototype.J=function(p,T){if(T=this.b[p],void 0===T)throw this.V(this.w,0,p),this.F;return T()},I=q.prototype,I.D=33,I.b$=15,I.I=134,I.m=17,I.X=195,I.P=143,I.a=155,function(p,T,k){if(T=p.J(p.h),!(T in p.H))throw p.V(p.N),p.F;return void 0==p.c&&(p.c=K(p.H,T-4),p.K=void 0),p.K!=T>>3&&(p.K=T>>3,k=[0,0,0,p.J(p.O)],p.$X=b(p.c,p.K,k)),x(p,p.h,T+1),p.H[T]^p.$X[T%8]}),J=(I.M=237,function(p,T,k,M,w,c){for(T={},k=N(p),T.o=N(p),T.v=[],M=N(p)-1,w=N(p),c=0;c<M;c++)T.v.push(N(p));for(T.L=p.J(k),T.i=p.J(w);M--;)T.v[M]=p.J(T.v[M]);return T}),W=(I.T=21,function(p,T,k,M){return M=function(){return T},k=function(){return M()},k[p.Y]=function(p){T=p},k}),B=(I.Gh=34,I.h_=177,I.PP=false,function(p,T,k,M,w,c){for(w=p.J(T),T=T==p.P?function(T,k,M,c){if(k=w.length,M=k-4>>3,w.Qb!=M){w.Qb=M,M=(M<<3)-4,c=[0,0,0,p.J(p.B)];try{w.q2=b(K(w,M),K(w,M+4),c)}catch(Z){throw Z;}}w.push(w.q2[k&7]^T)}:function(p){w.push(p)},M&&T(M&255),c=0,M=k.length;c<M;c++)T(k[c])}),S=(I.J_=189,I.h=167,function(p,T){return T=N(p),T&128&&(T=T&127|N(p)<<7),T}),r=(I.B=141,function(p,T){p.A=("E:"+T.message+":"+T.stack).slice(0,2048)}),a=function(p,T){for(T=Array(p);p--;)T[p]=255*Math.random()|0;return T},f=(I.C=22,I.a5=10,I.u=207,q.prototype.dL=function(p,T){T.push(p[0]<<24|p[1]<<16|p[2]<<8|p[3]),T.push(p[4]<<24|p[5]<<16|p[6]<<8|p[7]),T.push(p[8]<<24|p[9]<<16|p[10]<<8|p[11])},I.$=226,I.j=183,I.G=204,I.Y="toString",I.Vb=153,I.HP=12,I.F={},I.yb=251,I.N=31,I.l=176,I.g=139,I.Z="caller",q.prototype.A_=function(p,T,k,M){try{M=p[(T+2)%3],p[T]=p[T]-p[(T+1)%3]-M^(1==T?M<<k:M>>>k)}catch(w){throw w;}},function(p,T,k,M){return function(){if(!M||p.W)return x(p,p.J_,arguments),x(p,p.j,k),V(p,T)}}),O=function(p,T){p.f.push(p.b.slice()),p.b[p.h]=void 0,x(p,p.h,T)},b=(I.w=30,I.O=201,function(p,T,k,M){try{for(M=0;79669387488!=M;)p+=(T<<4^T>>>5)+T^M+k[M&3],M+=2489668359,T+=(p<<4^p>>>5)+p^M+k[M>>>11&3];return[p>>>24,p>>16&255,p>>8&255,p&255,T>>>24,T>>16&255,T>>8&255,T&255]}catch(w){throw w;}}),R=function(p,T,k,M){for(M=T-1,k=[];0<=M;M--)k[T-1-M]=p>>8*M&255;return k},K=(I.R=218,I.s=36,function(p,T){return p[T]<<24|p[T+1]<<16|p[T+2]<<8|p[T+3]}),D=function(p,T,k,M,w,c,H,n,C){return M=function(){return k()},w=q.prototype,c=w.S,C=w.V,H=w.U,n=q,k=function(p,Z,h){for(p=M[w.Z],Z=p===T,h=0,p=p&&p[w.Z];p&&p!=c&&p!=H&&p!=n&&p!=C&&20>h;)h++,p=p[w.Z];return k[w.Gh+Z+!(!p+(h+3>>3))]},M[w.Y]=function(p){k[w.s]=p},M[w.Y](p),p=M},U=(I=q.prototype,function(p,T,k,M,w){for(T=[],M=k=0;M<p.length;M++){for(w=p.charCodeAt(M);255<w;)T[k++]=w&255,w>>=8;T[k++]=w}return T}),l=(I.vP=function(p){return(p=window.performance)&&p.now?function(){return p.now()|0}:function(){return+new Date}}(),I.U=function(p,T,k,M,w,c,H,n,C,Q){if(this.A)return this.A;try{if(this.W=false,T=this.J(this.a).length,k=this.J(this.P).length,M=this.J(this.u),this.b[this.g]&&V(this,this.J(this.g)),w=this.J(this.G),0<w.length&&B(this,this.a,R(w.length,2).concat(w),this.b$),c=this.J(this.R)&511,c-=this.J(this.a).length+5,H=this.J(this.P),4<H.length&&(c-=H.length+3),0<c&&B(this,this.a,R(c,2).concat(a(c)),this.a5),4<H.length&&B(this,this.a,R(H.length,2).concat(H),this.Vb),n=a(2).concat(this.J(this.a)),n[1]=n[0]^3,C=window.btoa?window.btoa(y(n)).replace(/\\+/g,"-").replace(/\\//g,"_").replace(/=/g,""):void 0,C)C="!"+C;else for(w=0,C="";w<n.length;w++)Q=n[w][this.Y](16),1==Q.length&&(Q="0"+Q),C+=Q;this.J(this.a).length=T,this.J(this.P).length=k,x(this,this.u,M),p=C,this.W=true}catch(Z){r(this,Z),p=this.A}return p},I.S=function(p,T,k,M,w,c){try{for(T=5001,M=0,k=void 0,p=this.H.length;(--T||this.PP)&&(M=this.J(this.h))<p;)try{x(this,this.X,M),w=N(this),(k=this.J(w))&&k.call?k(this):this.V(this.T,0,w)}catch(H){H!=this.F&&(c=this.J(this.$),c!=this.$?(x(this,c,H),x(this,this.$,this.$)):this.V(this.C,H))}T||this.V(this.D)}catch(H){try{this.V(this.C,H)}catch(n){r(this,n)}}return this.J(this.j)},I.CP=function(p,T,k,M,w,c){for(k=[],c=M=0;c<p.length;c++)for(w=w<<T|p[c],M+=T;7<M;)M-=8,k.push(w>>M&255);return k},I.YX=function(p,T,k){return T^=T<<13,T^=T>>17,(T=(T^T<<5)&k)||(T=1),p^T},function(p,T,k,M,w,c){M=T&3,k=T&4,w=N(p),c=N(p),w=p.J(w),k&&(w=m((""+w).replace(/\\r\\n/g,"\\n"))),M&&B(p,c,R(w.length,2)),B(p,c,w)}),d=(I.u$=function(p,T){return T=this.U(),p&&p(T),T},function(p,T,k,M){k=N(p),M=N(p),B(p,M,R(p.J(k),T))}),X=function(p,T,k,M){for(k=N(p),M=0;0<T;T--)M=M<<8|N(p);x(p,k,M)};I.Z5=function(p,T,k,M,w){for(w=M=0;w<p.length;w++)M+=p.charCodeAt(w),M+=M<<10,M^=M>>6;return M+=M<<3,M^=M>>11,p=M+(M<<15)>>>0,M=new Number(p&(1<<T)-1),M[0]=(p>>>T)%k,M};try{window.addEventListener("unload",function(){},false)}catch(p){}z("botguard.bg",q),z("botguard.bg.prototype.invoke",q.prototype.u$);')})()</script>
  <script type="text/javascript">
  document.bg = new botguard.bg('');
  </script>
<script>
  gaia = window.gaia || {};
  gaia.ps = gaia.ps || {};
...
else c=PS_rb(c),PS_eb(a)?a.b.remove(String(b),c,d,e):a&&(a=PS_ub(a))&&(b=PS_mb(a,b,c,!!d,e))&&PS_v(b)},PS_v=function(a){if(!PS_f(a)&&a&&!a.V){var b=a.src;if(PS_eb(b))PS_lb(b.b,a);else{var c=a.type,d=a.a;b.removeEventListener?b.removeEventListener(c,d,a.aa):b.detachEvent&&b.detachEvent(PS_wb(c),d);PS_pb--;(c=PS_ub(b))?(PS_lb(c,a),0==c.c&&(c.src=null,b[PS_nb]=null)):PS_hb(a)}}},PS_wb=function(a){return a in PS_ob?PS_ob[a]:PS_ob[a]="on"+a},PS_Bb=function(a,b,c,d){var e=!0;if(a=PS_ub(a))if(b=a.a[b.toString()])for(b=
b.concat(),a=0;a<b.length;a++){var f=b[a];f&&f.aa==c&&!f.V&&(f=PS_Ab(f,d),e=e&&!1!==f)}return e},PS_Ab=function(a,b){var c=a.listener,d=a.ca||a.src;a.$&&PS_v(a);return c.call(d,b)},PS_xb=function(a,b){if(a.V)return!0;if(!PS_$a){var c;if(!(c=b))a:{c=["window","event"];for(var d=PS_a,e;e=c.shift();)if(null!=d[e])d=d[e];else{c=null;break a}c=d}e=c;c=new PS_bb(e,this);d=!0;if(!(0>e.keyCode||void 0!=e.returnValue)){a:{var f=!1;if(0==e.keyCode)try{e.keyCode=-1;break a}catch(k){f=!0}if(f||void 0==e.returnValue)e.returnValue=
!0}e=[];for(f=c.a;f;f=f.parentNode)e.push(f);for(var f=a.type,g=e.length-1;0<=g;g--){c.a=e[g];var h=PS_Bb(e[g],f,!0,c),d=d&&h}for(g=0;g<e.length;g++)c.a=e[g],h=PS_Bb(e[g],f,!1,c),d=d&&h}return d}return PS_Ab(a,new PS_bb(b,this))},PS_ub=function(a){a=a[PS_nb];return a instanceof PS_ib?a:null},PS_Cb="__closure_events_fn_"+(1E9*Math.random()>>>0),PS_rb=function(a){PS_j(a,"Listener can not be null.");if("function"==PS_c(a))return a;PS_j(a.handleEvent,"An object listener must have handleEvent method.");
a[PS_Cb]||(a[PS_Cb]=function(b){return a.handleEvent(b)});return a[PS_Cb]};var PS_Db=function(a){var b;b=b||0;return function(){return a.apply(this,Array.prototype.slice.call(arguments,0,b))}},PS_Eb=function(a){var b=!1,c;return function(){b||(c=a(),b=!0);return c}};var PS_w=function(a,b,c){PS_l.call(this);this.a=null;this.h=!1;this.f=a;this.i=c;this.b=b||window;this.g=PS_g(this.j,this)};PS_i(PS_w,PS_l);
...
PS_N.prototype.remove=function(a){return PS_O(this.c,a)?(delete this.c[a],this.b--,this.f++,this.a.length>2*this.b&&PS_Ac(this),!0):!1};var PS_Ac=function(a){if(a.b!=a.a.length){for(var b=0,c=0;b<a.a.length;){var d=a.a[b];PS_O(a.c,d)&&(a.a[c++]=d);b++}a.a.length=c}if(a.b!=a.a.length){for(var e={},c=b=0;b<a.a.length;)d=a.a[b],PS_O(e,d)||(a.a[c++]=d,e[d]=1),b++;a.a.length=c}},PS_Bc=function(a,b){return PS_O(a.c,b)?a.c[b]:void 0};
PS_N.prototype.set=function(a,b){PS_O(this.c,a)||(this.b++,this.a.push(a),this.f++);this.c[a]=b};PS_N.prototype.forEach=function(a,b){for(var c=this.J(),d=0;d<c.length;d++){var e=c[d],f=PS_Bc(this,e);a.call(b,f,e,this)}};PS_N.prototype.clone=function(){return new PS_N(this)};
PS_N.prototype.g=function(a){PS_Ac(this);var b=0,c=this.f,d=this,e=new PS_zc;e.next=function(){if(c!=d.f)throw Error("The map has changed since the iterator was created");if(b>=d.a.length)throw PS_yc;var e=d.a[b++];return a?e:d.c[e]};return e};var PS_O=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};var PS_P=function(a,b){if("FORM"==a.tagName)for(var c=a.elements,d=0;a=c[d];d++)PS_P(a,b);else 1==b&&a.blur(),a.disabled=b};var PS_Q=function(a){PS_l.call(this);this.b=a;this.a={}};PS_i(PS_Q,PS_l);
...
PS_Hd),c&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null},PS_Hd=function(a){a=a.charCodeAt(0);return"%"+(a>>4&15).toString(16)+(a&15).toString(16)},PS_Bd=/[#\/\?@]/g,PS_Dd=/[\#\?:]/g,PS_Cd=/[\#\?]/g,PS_Gd=/[\#\?@]/g,PS_Ed=/#/g,PS_Z=function(a,b,c){this.c=this.a=null;this.b=a||null;this.f=!!c},PS__=function(a){a.a||(a.a=new PS_N,a.c=0,a.b&&PS_Xc(a.b,function(b,c){var d=PS_ma(b);PS__(a);a.b=null;var d=PS_0(a,d),e=PS_Bc(a.a,d);e||a.a.set(d,e=[]);e.push(c);a.c=PS_Ba(a.c)+1}))};
PS_Z.prototype.remove=function(a){PS__(this);a=PS_0(this,a);return PS_O(this.a.c,a)?(this.b=null,this.c=PS_Ba(this.c)-PS_Bc(this.a,a).length,this.a.remove(a)):!1};var PS_Id=function(a,b){PS__(a);b=PS_0(a,b);return PS_O(a.a.c,b)};PS_Z.prototype.J=function(){PS__(this);for(var a=this.a.H(),b=this.a.J(),c=[],d=0;d<b.length;d++)for(var e=a[d],f=0;f<e.length;f++)c.push(b[d]);return c};
PS_Z.prototype.H=function(a){PS__(this);var b=[];if(PS_e(a))PS_Id(this,a)&&(b=PS_Ma(b,PS_Bc(this.a,PS_0(this,a))));else{a=this.a.H();for(var c=0;c<a.length;c++)b=PS_Ma(b,a[c])}return b};PS_Z.prototype.set=function(a,b){PS__(this);this.b=null;a=PS_0(this,a);PS_Id(this,a)&&(this.c=PS_Ba(this.c)-PS_Bc(this.a,a).length);this.a.set(a,[b]);this.c=PS_Ba(this.c)+1;return this};
...
var PS_0=function(a,b){var c=String(b);a.f&&(c=c.toLowerCase());return c},PS_Fd=function(a,b){b&&!a.f&&(PS__(a),a.b=null,a.a.forEach(function(a,b){var e=b.toLowerCase();b!=e&&(this.remove(b),this.remove(e),0<a.length&&(this.b=null,this.a.set(PS_0(this,e),PS_Na(a)),this.c=PS_Ba(this.c)+a.length))},a));a.f=b};var PS_Jd=function(){throw Error("Do not instantiate directly");};PS_Jd.prototype.a=null;PS_Jd.prototype.toString=function(){return this.c};PS_p&&PS_s(8);var PS_Kd=function(){PS_Jd.call(this)};PS_i(PS_Kd,PS_Jd);(function(a){function b(a){this.c=a}b.prototype=a.prototype;return function(a,d){var e=new b(String(a));void 0!==d&&(e.a=d);return e}})(PS_Kd);(function(a){function b(a){this.c=a}b.prototype=a.prototype;return function(a,d){var e=String(a);if(!e)return"";e=new b(e);void 0!==d&&(e.a=d);return e}})(PS_Kd);var PS_Ld=function(){return!(PS_("iPad")||PS_("Android")&&!PS_("Mobile")||PS_("Silk"))&&(PS_("iPod")||PS_("iPhone")||PS_("Android")||PS_("IEMobile"))};var PS_Md=function(a,b){for(var c=[a],d=b.length-1;0<=d;--d)c.push(typeof b[d],b[d]);return c.join("\x0B")};var PS_Nd=function(){PS_u.call(this,"navigate")};PS_i(PS_Nd,PS_u);var PS_4=function(a,b,c,d){PS_x.call(this);if(a&&!b)throw Error("Can't use invisible history without providing a blank page.");var e;if(c)e=c;else{e="history_state"+PS_Od;var f=PS_kc("input",{type:"text",name:e,id:e,style:PS_4b("display:none")});document.write(PS_H(f));e=PS_oc(document,e)}this.o=e;c=c?(c=PS_vc(c))?c.parentWindow||c.defaultView:window:window;this.a=c;this.s=b;PS_p&&!b&&(this.s="https"==window.location.protocol?PS_ec(PS_3b(PS_4b("https:///"))):PS_ec(PS_3b(PS_4b('javascript:""'))));
this.f=new PS_z(150);PS_m(this,this.f);this.h=!a;this.g=new PS_Q(this);if(a||PS_1){var g;if(d)g=d;else{a="history_iframe"+PS_Od;c=this.s;b={id:a,style:PS_4b("display:none"),sandbox:void 0};c&&PS_dc(c);d={};d.src=c||null;d.srcdoc=null;c={sandbox:""};e={};for(g in d)PS_j(g.toLowerCase()==g,"Must be lower case"),e[g]=d[g];for(g in c)PS_j(g.toLowerCase()==g,"Must be lower case"),e[g]=c[g];for(g in b){f=g.toLowerCase();if(f in d)throw Error('Cannot override "'+f+'" attribute, got "'+g+'" with value "'+
b[g]+'"');f in c&&delete e[f];e[g]=b[g]}g=PS_jc("iframe",e,void 0);document.write(PS_H(g));g=PS_oc(document,a)}this.u=g;this.I=!0}PS_1&&(PS_R(this.g,this.a,"load",this.L),this.G=this.v=!1);this.h?PS_Pd(this,PS_2(this),!0):PS_3(this,this.o.value);PS_Od++};PS_i(PS_4,PS_x);PS_4.prototype.m=!1;PS_4.prototype.l=!1;PS_4.prototype.i=null;
var PS_Qd=function(a,b){var c=b||PS_Md;return function(){var b=this||PS_a,b=b.closure_memoize_cache_||(b.closure_memoize_cache_={}),e=c(a[PS_ea]||(a[PS_ea]=++PS_fa),arguments);return b.hasOwnProperty(e)?b[e]:b[e]=a.apply(this,arguments)}}(function(){return PS_p?8<=Number(PS_t):"onhashchange"in PS_a}),PS_1=PS_p&&!(8<=Number(PS_t));PS_4.prototype.j=null;PS_4.prototype.c=function(){PS_4.P.c.call(this);this.g.ba();PS_Rd(this,!1)};
var PS_Rd=function(a,b){if(b!=a.m)if(PS_1&&!a.v)a.G=b;else if(b)if(PS_o?PS_R(a.g,a.a.document,PS_Sd,a.U):PS_q&&PS_R(a.g,a.a,"pageshow",a.T),PS_Qd()&&a.h)PS_R(a.g,a.a,"hashchange",a.M),a.m=!0,PS_y(a,new PS_Nd(PS_2(a)));else{if(!PS_p||PS_Ld()||a.v)PS_R(a.g,a.f,"tick",PS_g(a.w,a,!0)),a.m=!0,PS_1||(a.i=PS_2(a),PS_y(a,new PS_Nd(PS_2(a)))),PS_Mb(a.f)}else a.m=!1,PS_Fc(a.g),PS_Lb(a.f)};PS_4.prototype.L=function(){this.v=!0;this.o.value&&PS_3(this,this.o.value,!0);PS_Rd(this,this.G)};
PS_4.prototype.T=function(a){a.R.persisted&&(PS_Rd(this,!1),PS_Rd(this,!0))};PS_4.prototype.M=function(){var a=PS_Td(this.a);a!=this.i&&PS_Ud(this,a)};
var PS_2=function(a){return null!=a.j?a.j:a.h?PS_Td(a.a):PS_Vd(a)||""},PS_Td=function(a){a=a.location.href;var b=a.indexOf("#");return 0>b?"":a.substring(b+1)},PS_Wd=function(a,b,c){PS_2(a)!=b&&(a.h?(PS_Pd(a,b,c),PS_Qd()||PS_p&&!PS_Ld()&&PS_3(a,b,c,void 0),a.m&&a.w()):(PS_3(a,b,c),a.j=a.i=a.o.value=b,PS_y(a,new PS_Nd)))},PS_Pd=function(a,b,c){a=a.a.location;var d=a.href.split("#")[0],e=-1!=a.href.indexOf("#");if(PS_1||e||b)d+="#"+b;d!=a.href&&(c?a.replace(d):a.href=d)},PS_3=function(a,b,c,d){if(a.I||
b!=PS_Vd(a))if(a.I=!1,b=encodeURIComponent(String(b)),PS_p){var e=PS_wc(a.u);e.open("text/html",c?"replace":void 0);c=PS_lc(PS_kc("title",{},d||a.a.document.title),PS_kc("body",{},b));e.write(PS_H(c));e.close()}else if(PS_Fa(a.s,PS_F,"this.iframeSrc_ must be set on calls to setIframeToken_"),e=PS_dc(a.s)+"#"+b,a=a.u.contentWindow)c?a.location.replace(e):a.location.href=e},PS_Vd=function(a){if(PS_p)return a=PS_wc(a.u),a.body?PS_ma(a.body.innerHTML):null;var b=a.u.contentWindow;if(b){var c;try{c=PS_ma(PS_Td(b))}catch(d){return a.l||
(1!=a.l&&PS_Nb(a.f,1E4),a.l=!0),null}a.l&&(0!=a.l&&PS_Nb(a.f,150),a.l=!1);return c||null}return null};PS_4.prototype.w=function(){if(this.h){var a=PS_Td(this.a);a!=this.i&&PS_Ud(this,a)}if(!this.h||PS_1)if(a=PS_Vd(this)||"",null==this.j||a==this.j)this.j=null,a!=this.i&&PS_Ud(this,a)};var PS_Ud=function(a,b){a.i=a.o.value=b;a.h?(PS_1&&PS_3(a,b),PS_Pd(a,b)):PS_3(a,b);PS_y(a,new PS_Nd(PS_2(a)))};PS_4.prototype.U=function(){PS_Lb(this.f);PS_Mb(this.f)};
var PS_Sd=["mousedown","keydown","mousemove"],PS_Od=0;var PS_Xd=function(a,b){PS_l.call(this);this.b=a;this.f=null;this.a=new PS_4;PS_m(this,this.a);PS_Rd(this.a,!0);PS_Wd(this.a,a,!0);this.h=b||PS_ba;var c=new PS_Q(this);PS_m(this,c);PS_R(c,this.a,"navigate",this.g)};PS_i(PS_Xd,PS_l);var PS_Yd={Da:"identifier",Ea:"password"},PS_5=function(a){return"identifier"==a.b};PS_Xd.prototype.g=function(a){var b=PS_2(this.a),c;a:{for(c in PS_Yd)if(PS_Yd[c]==b){c=!0;break a}c=!1}c&&b!=this.b?(this.f=this.b,this.b=b,this.h(a)):PS_Wd(this.a,this.b,!1)};var PS_Zd=function(a){PS_l.call(this);this.m=a;this.j=PS_K("Email");this.o=PS_K("Passwd");this.a=PS_K("Email-hidden");this.g=this.a.value;this.b=PS_K("Passwd-hidden");this.h=PS_K("identifier-shown");this.v=PS_Da(PS_uc(this.h),"No children found under the element with id: identifier-shown");this.i=PS_K("password-shown");this.w=PS_Da(PS_uc(this.i),"No children found under the element with id: password-shown");this.l="";this.f=new PS_Q(this);PS_m(this,this.f);PS_sc(PS_5(this.m)?this.i:this.h);PS_rc(this.a,
{name:"Email"});PS_R(this.f,this.j,"input",this.s);PS_R(this.f,this.a,"change",this.F)};PS_i(PS_Zd,PS_l);PS_Zd.prototype.s=function(){this.b.value&&(PS_Ec(this.f,this.j,"input",this.s),this.l=this.b.value)};PS_Zd.prototype.F=function(){this.a.value=this.g};var PS_7=function(a,b,c){PS_l.call(this);this.b=new PS_Xd(1==a?"password":"identifier",PS_g(this.qa,this));PS_m(this,this.b);this.ta=PS_M("main-content");this.m=PS_K("gaia_loginform");this.l=PS_M("slide-out");this.h=PS_M("slide-in");this.a=PS_K("Email");this.i=PS_K("Passwd");this.o=PS_K("next");this.ia=PS_K("signIn");this.u=PS_K("back-arrow");this.s=PS_M("circle-mask");this.Aa=PS_K("email-display");this.ga=PS_K("profile-name");this.Ba=PS_K("link-forgot-passwd");this.N=null;this.A=PS_K("canvas");this.T=
...
"mozTransitionEnd"],function(a){PS_R(this.f,this.l,a,this.va);PS_R(this.f,this.h,a,this.xa)},this);PS_Hc(this.u,this.ua,this,this.f);this.m.action=b;this.W=new PS_Zd(this.b);PS_m(this,this.W);0==a?PS_6(this.a):(PS_6(this.i),PS_Sb(this.u,"shift-form"));c&&!this.o.disabled&&this.Z()};PS_i(PS_7,PS_l);var PS__d=["gaia","pages","PasswordSeparationPage"],PS_8=PS_a;PS__d[0]in PS_8||!PS_8.execScript||PS_8.execScript("var "+PS__d[0]);
for(var PS_0d;PS__d.length&&(PS_0d=PS__d.shift());)!PS__d.length&&PS_b(PS_7)?PS_8[PS_0d]=PS_7:PS_8[PS_0d]?PS_8=PS_8[PS_0d]:PS_8=PS_8[PS_0d]={};var PS_1d={"-moz-transform":!0,"-ms-transform":!0,"-o-transform":!0,"-webkit-transform":!0,transform:!0};PS_7.prototype.Z=function(a){PS_5(this.b)?(a&&a.preventDefault instanceof Function&&a.preventDefault(),PS_P(this.o,!0),PS_P(this.a,!0),PS_2d(this)):(PS_P(this.ia,!0),PS_P(this.o,!0),this.i.setAttribute("readonly",""))};
PS_7.prototype.ua=function(a){a.preventDefault();PS_Wd(this.b.a,"identifier",!1)};
var PS_2d=function(a){if(!a.M){a.M=!0;var b={};b.Email=a.a.value;b.requestlocation=PS_a.location.href;a.L&&(b["identifier-captcha-input"]=a.j.value,b.identifiertoken=a.U.value);var c="js_disabled";try{document.bg.invoke(function(a){c=a})}catch(f){c=""}b.bgresponse=c;PS_3d(a,b);var d=[],e;for(e in b)d.push(e+"="+encodeURIComponent(b[e]));PS_sb(PS_9c(PS_g(a.wa,a),d.join("&")),"timeout",function(){PS_9(this);PS_4d(this,"timeoutError")},!1,a)}},PS_3d=function(a,b){for(var c=PS_L("INPUT","",a.m),d=0,e;e=
c[d];d++)"hidden"==e.type&&e.value&&!b[e.name]&&(b[e.name]=e.value)},PS_6d=function(a,b){PS_5d(a);a.ma=b.name;a.Ca=b.email;a.ha=b.photo_url;a.oa=b.recovery_url;if(b.shadow_email){a.W.u=b.shadow_email;var c=document.createElement("INPUT");c.setAttribute("type","hidden");c.setAttribute("name","ignoreShadow");c.setAttribute("value","1");a.m.appendChild(c)}a.za.value=b.encoded_profile_information;PS_Wd(a.b.a,"password",!1)};
PS_7.prototype.wa=function(a){this.M=!1;var b=PS_gd(a.target);if(200==b){var c;a=a.target;try{c=a.a?a.a.responseText:""}catch(d){PS_S(a.C,"Can not get responseText: "+d.message),c=""}c=PS_Ic(c);"SHOW_ERROR"==c.action?(PS_9(this),PS_4d(this,c.error_msg)):"REDIRECT"==c.action?(a=c.redirectUrl,c=PS_a.location,a=a instanceof PS_E?a:PS_bc(a),c.href=PS_9b(a)):"SHOW_CAPTCHA"==c.action?(PS_9(this),PS_7d(this,c),PS_8d(this)):"SHOW_CAPTCHA_AND_ERROR"==c.action?(PS_9(this),PS_7d(this,c),PS_4d(this,c.error_msg)):
(PS_9(this),PS_6d(this,c))}else 0<b&&(PS_9(this),PS_6d(this,{name:"",email:this.a.value,photo_url:"",recovery_url:"https://accounts.google.com/RecoverAccount?Email="+this.a.value,encoded_profile_information:""}))};var PS_9=function(a){PS_P(a.o,!1);PS_P(a.a,!1)};
PS_7.prototype.qa=function(){PS_Pb(this.I);var a=this.W;PS_5(a.m)?(PS_sc(a.i),a.g=a.a.value="",a.o.value="",a.h.appendChild(a.v),a.l=a.b.value):(a.u?a.g=a.a.value=a.u:a.g=a.a.value=a.j.value,a.l!==a.b.value&&(a.o.value=a.b.value),PS_sc(a.h),a.i.appendChild(a.w));if(PS_5(this.b)){if(PS_B(this.l,"hide-form",!1),PS_9d(this),PS_$d(this,100,0),PS_$(this,"shift-form",!1),PS_Tb(this.u,"shift-form"),"password"==this.b.f&&(PS_nd(this.s,"0.01"),a=this.I,PS_Pb(a),a.a=PS_Ob(a.g,PS_b(void 0)?void 0:a.h),PS_5d(this),
PS_8d(this),PS_P(this.ia,!1),PS_P(this.o,!1),this.i.removeAttribute("readonly"),a=this.m.ignoreShadow))if(PS_ca(a))for(var b=a.length,c=0;c<b;c++)a[c].value="0";else a.value="0"}else this.F&&PS_X(this.F,!1),PS_B(this.h,"hide-form",!1),PS_9d(this),PS_$d(this,0,100),PS_$(this,"shift-form",!0),PS_ae(this)};
var PS_ae=function(a){var b="https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=96";a.ha&&(b=a.ha+"?sz="+String(a.A.width));PS_Ib(new PS_w(function(){this.N=document.createElement("IMG");this.N.src=b;this.A.getContext("2d").clearRect(0,0,this.A.width,this.A.height);this.ma?(PS_xc(this.ga,this.ma),PS_X(this.ga,!0),PS_$(this,"no-name",!1)):(PS_X(this.ga,!1),PS_$(this,"no-name",!0));PS_xc(this.Aa,this.Ca||"");this.oa&&(this.Ba.href=this.oa)},window,a))},PS_$=
function(a,b,c){PS_B(a.ja,b,c);PS_be(a,b,c)},PS_be=function(a,b,c){PS_B(a.w,b,c);PS_B(a.ta,b,c)},PS_$d=function(a,b,c){PS_W(a.l,"transitionDelay",b+"ms");PS_W(a.h,"transitionDelay",c+"ms")},PS_9d=function(a){a.ja.offsetWidth},PS_4d=function(a,b){PS_6(a.a);var c=PS_K("errormsg_0_Email"),d;if("INGE"==b){d=PS_K("inge").cloneNode(!0);var e=PS_uc(d),f;f=new PS_vd(e.href);var g=new PS_Z(f.g);g.set("EmailAddress",PS_ua(a.a.value));f=PS_zd(f,PS_Y(g.toString())).toString();e.href=f}else"timeoutError"==b&&
...
PS_hd()+PS_ya(e),void 0!==d.style[e])){e=(PS_r?"-webkit":PS_q?"-moz":PS_p?"-ms":PS_o?"-o":null)+"-transform";break b}e="transform"}d=(d=PS_ld(d,e)||PS_ld(d,"transform"))?(d=d.match(PS_pd))?new PS_J(parseFloat(d[1]),parseFloat(d[2])):new PS_J(0,0):new PS_J(0,0);d=d.y+(a.G-c);0>d&&(c=a.w,PS_sd()&&(d=PS_td()?"translate3d(0px,"+d+"px,0px)":"translate(0px,"+d+"px)",PS_W(c,PS_ud(),d)));PS_$(a,"has-error",!0);PS_Sb(a.a,"form-error")},PS_8d=function(a){a.G=0;PS_W(a.w,"transform","");PS_xc(PS_K("errormsg_0_Email"),
...
var PS_5d=function(a){PS_be(a,"has-captcha",!1);PS_tc(PS_pc("captcha-container",a.h));a.L=!1;PS_sc(a.v);a.j.value="";PS_X(a.T,!1)},PS_6=function(a){!a||"function"!=typeof a.focus||PS_Za()||PS_("iPad")||PS_("iPod")||PS_("Trident")||PS_("MSIE")||a.focus()};PS_7.prototype.va=function(a){a.target==this.l&&PS_1d[a.R.propertyName]&&(PS_5(this.b)?(this.F&&PS_X(this.F,!0),PS_6(this.a)):(PS_8d(this),PS_Sb(this.u,"shift-form"),PS_B(this.l,"hide-form",!0),PS_9d(this),PS_9d(this)))};
PS_7.prototype.xa=function(a){a.target==this.h&&PS_1d[a.R.propertyName]&&(PS_5(this.b)?(PS_B(this.h,"hide-form",!0),PS_9d(this)):(this.N.complete?this.ka.call(this):PS_Dc(this.f,this.N,"load",this.ka,void 0),PS_6(this.i)))};
</script>
  <script>
